...
vcur_kaggle_competencia_peque="labo-1-virtual-inicial"
vcur_kaggle_competencia_sr="labo-1-virtual-2026-analista-sr"
vcur_kaggle_competencia_jr="labo-1-virtual-2026-analista-jr"
vcur_kaggle_competencia_mgr="labo-1-virtual-2026-analista-mgr"
vcur_kaggle_submit_ok="Successfully submitted to Labo 1 Virtual Inicial"

export vcur_github_catedra_user="labo-imp"
export vcur_github_catedra_repo="labo2026v"
...
export vcur_mlflow_usuario="labo2026v"
