...
gcloud beta compute instances create instance-instalacion \
    ...
    --create-disk=auto-delete=yes,boot=yes,device-name=instance-instalacion,image=projects/ubuntu-os-cloud/global/images/ubuntu-minimal-2604-resolute-amd64-v20260722,mode=rw,size=64,type=pd-standard \
